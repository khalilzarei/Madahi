...
import com.khz.madahi.helper.TypefaceUtil;
...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        TypefaceUtil.overrideFont(this, "fonts/" + sessionManager.getFont());
        instance = this;
        ViewPump.init(ViewPump.builder().addInterceptor(new CalligraphyInterceptor(new CalligraphyConfig.Builder()
                .setDefaultFontPath("fonts/" + sessionManager.getFont()).build())).build());
    }
